...
class LaunchIntegrationsSection:
    PADDING_X: int = 16
    PADDING_Y: int = 16
    ...
    def _get_title_frame(self) -> ctk.CTkFrame:
        ...
        FluentLabel(title_row, Localizer.strings["menu.launch_integrations"]["title"], font_size=28, font_weight="bold").grid(column=0, row=0, sticky="w")
        self.tooltip_button = FluentToolTipButton(get_root_instance(), master=title_row, wraplength=400, tooltip_title=Localizer.strings["menu.launch_integrations"]["tooltip.title"], tooltip_message=Localizer.strings["menu.launch_integrations"]["tooltip.message"], tooltip_orientation="down", toplevel=True)
