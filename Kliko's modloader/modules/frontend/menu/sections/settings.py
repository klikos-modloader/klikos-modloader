...
# region load
    ...
    def _load_content(self, master) -> None:
        ...
        Label(frame, "menu.settings.content.appearance.title", style="body_strong").grid(column=0, row=0, sticky="sw", pady=(self._ENTRY_PADDING[1], self._ENTRY_INNER_GAP), padx=self._ENTRY_PADDING[0])
        ...
        Label(frame, "menu.settings.content.language.title", style="body_strong").grid(column=0, row=0, sticky="sw", pady=(self._ENTRY_PADDING[1], self._ENTRY_INNER_GAP), padx=self._ENTRY_PADDING[0])
        ...
        Label(frame, "menu.settings.content.check_for_updates.title", style="body_strong").grid(column=0, row=0, sticky="sw", pady=(self._ENTRY_PADDING[1], 0), padx=(self._ENTRY_PADDING[0], 0))
        Label(frame, "menu.settings.content.check_for_updates.description", lambda string: Localizer.format(string, {"{app.name}": ProjectData.NAME}), style="caption").grid(column=0, row=1, sticky="nw", pady=(0, self._ENTRY_PADDING[1]), padx=(self._ENTRY_PADDING[0], 0))
        ...
        frame.grid_columnconfigure(0, weight=1)
        frame.grid(column=0, row=row_counter, sticky="nsew", pady=(self._ENTRY_GAP, 0))
        Label(frame, "menu.settings.content.confirm_launch.title", style="body_strong").grid(column=0, row=0, sticky="sw", pady=(self._ENTRY_PADDING[1], 0), padx=(self._ENTRY_PADDING[0], 0))
        Label(frame, "menu.settings.content.confirm_launch.description", lambda string: Localizer.format(string, {"{roblox.common}": Localizer.Key("roblox.common")}), style="caption").grid(column=0, row=1, sticky="nw", pady=(0, self._ENTRY_PADDING[1]), padx=(self._ENTRY_PADDING[0], 0))
        ...
        frame.grid_columnconfigure(0, weight=1)
        frame.grid(column=0, row=row_counter, sticky="nsew", pady=(self._ENTRY_GAP, 0))
        Label(frame, "menu.settings.content.deployment_info.title", style="body_strong").grid(column=0, row=0, sticky="sw", pady=(self._ENTRY_PADDING[1], 0), padx=(self._ENTRY_PADDING[0], 0))
        Label(frame, "menu.settings.content.deployment_info.description", lambda string: Localizer.format(string, {"{roblox.common}": Localizer.Key("roblox.common")}), style="caption").grid(column=0, row=1, sticky="nw", pady=(0, self._ENTRY_PADDING[1]), padx=(self._ENTRY_PADDING[0], 0))
        ...
        frame.grid_columnconfigure(0, weight=1)
        frame.grid(column=0, row=row_counter, sticky="nsew", pady=(self._ENTRY_GAP, 0))
        Label(frame, "menu.settings.content.force_reinstall.title", lambda string: Localizer.format(string, {"{roblox.common}": Localizer.Key("roblox.common")}), style="body_strong").grid(column=0, row=0, sticky="sw", pady=(self._ENTRY_PADDING[1], 0), padx=(self._ENTRY_PADDING[0], 0))
        Label(frame, "menu.settings.content.force_reinstall.description", lambda string: Localizer.format(string, {"{roblox.common}": Localizer.Key("roblox.common")}), style="caption").grid(column=0, row=1, sticky="nw", pady=(0, self._ENTRY_PADDING[1]), padx=(self._ENTRY_PADDING[0], 0))
        ...
        frame.grid_columnconfigure(0, weight=1)
        frame.grid(column=0, row=row_counter, sticky="nsew", pady=(self._ENTRY_GAP, 0))
        Label(frame, "menu.settings.content.disable_mods.title", style="body_strong").grid(column=0, row=0, sticky="sw", pady=(self._ENTRY_PADDING[1], 0), padx=(self._ENTRY_PADDING[0], 0))
        Label(frame, "menu.settings.content.disable_mods.description", style="caption").grid(column=0, row=1, sticky="nw", pady=(0, self._ENTRY_PADDING[1]), padx=(self._ENTRY_PADDING[0], 0))
        ...
        frame.grid_columnconfigure(0, weight=1)
        frame.grid(column=0, row=row_counter, sticky="nsew", pady=(self._ENTRY_GAP, 0))
        Label(frame, "menu.settings.content.disable_fastflags.title", style="body_strong").grid(column=0, row=0, sticky="sw", pady=(self._ENTRY_PADDING[1], 0), padx=(self._ENTRY_PADDING[0], 0))
        Label(frame, "menu.settings.content.disable_fastflags.description", style="caption").grid(column=0, row=1, sticky="nw", pady=(0, self._ENTRY_PADDING[1]), padx=(self._ENTRY_PADDING[0], 0))
